...
namespace OrderManagement.Persistence.Ef.Migrations
{
    ...
    [Migration("20240530102031_add_state_to_order")]
    partial class add_state_to_order
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderManagement.Domain.OrderAggregate.Order", b =>
                {
                    b.OwnsOne("OrderManagement.Domain.OrderAggregate.Money", "Total", b1 =>
                        {
                    ...
                    b.OwnsMany("OrderManagement.Domain.OrderAggregate.OrderItem", "OrderItems", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uniqueidentifier");
